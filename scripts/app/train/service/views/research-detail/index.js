...
exports.store = {
    models: {
        ...
        researchRecord: { url: '../train/questionnaire-survey/front/research-detail' },
        questions: {
            mixin: {
                    ...
                    return {
                        researchAnswerRecords: JSON.stringify(_.map(this.data, function(a) {
                            return {
                                ...
                                score: a.value[0].score || 0,
                                idea: _.map(a.value, 'idea').join(','),
        ...
        form: { url: '../train/questionnaire-survey/submit' }
    },
    callbacks: {
