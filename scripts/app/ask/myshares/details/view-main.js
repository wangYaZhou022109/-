...
exports.handlers = {
    discussanswer: function(id) {
        ...
        if (el.style.display === 'none') {
            ...
            region.show('ask/myshares/reply', { id: id, closeStatus: details.data.closeStatus });
        } else {
...
exports.dataForActions = {
    ...
    discuss: function(payload) {
        ...
        // console.log(this.components.content.html());
        // console.log(this.components.content.text());
        // data = this.components.content.html();
        // data = this.components.content.text();
