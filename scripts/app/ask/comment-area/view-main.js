...
exports.dataForTemplate = {
    comments: function(data) {
        _.forEach(data.comments.questionDiscussList || [], function(comment) {
            ...
            r.createTime = y + '-' + m + '-' + d + '   ' + h + ':' + mi;
            if (!r.member.headPortrait) {
                r.member.headPortrait = 'images/default-userpic.png';
            } else {
                r.member.headPortrait = '/api/v1/human/file/download?id=' + r.member.headPortrait;
            }
        });
